...
def launch_setup(context, *args, **kwargs):
    ...
    planning_pipeline_config = {
        ...
        "pilz": load_yaml("hdr35_20_moveit_config", "config/pilz_industrial_motion_planner_planning.yaml"),
        "ompl": load_yaml("hdr35_20_moveit_config", "config/ompl_planning.yaml"),
    }
