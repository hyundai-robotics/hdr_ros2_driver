    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution([
                FindPackageShare(LaunchConfiguration('hdr20_17_moveit_config')),
                'config',
...
def launch_setup(context, *args, **kwargs):
    ...
    moveit_config_pkg = get_package_share_directory('hdr20_17_moveit_config')
    ...
    srdf_xacro = os.path.join(moveit_config_pkg, 'config', 'hdr20_17.srdf.xacro')
    ...
    robot_description_kinematics_yaml = load_yaml("hdr20_17_moveit_config", "config/kinematics.yaml")
    robot_description_kinematics = {
        "robot_description_kinematics": robot_description_kinematics_yaml
    }

    joint_limits_yaml = load_yaml(
        "hdr20_17_moveit_config", "config/joint_limits.yaml"
    )
    pilz_cartesian_limits_yaml = load_yaml(
        "hdr20_17_moveit_config", "config/pilz_cartesian_limits.yaml"
    )
    ...
    planning_pipeline_config = {
        ...
        "pilz": load_yaml("hdf8_8_moveit_config", "config/pilz_industrial_motion_planner_planning.yaml"),
        "ompl": load_yaml("hdf8_8_moveit_config", "config/ompl_planning.yaml"),
    }

    moveit_controllers = {
        "moveit_simple_controller_manager": load_yaml("hdr20_17_moveit_config", "config/moveit_controllers.yaml"),
